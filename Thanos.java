...
public class Thanos {
    ...
    public static void main(String[] args) {
        ...
        // Comparator<Hero> compareHero = new Comparator<Hero>() {
        //     @Override
        ...
        // Collections.sort(heroes, compareHero);
        ...
        Comparator<Hero> compareAgeHero = new Comparator<Hero>() {
            @Override
            public int compare(Hero hero1, Hero hero2) {
        ...
        Collections.sort(heroes, compareAgeHero);
